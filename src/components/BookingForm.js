        ...
        <form>
          <fieldset className="formField">
            ...
            <div className="btnReceive">
              <input aria-label="reserve" type='submit' onClick={handleSubmit} value={"Make Your Reservation"}></input>
              <input aria-label="cancel" type="submit" value="Cancel" onClick={() => navigate('/')}></input>
            </div>
          </fieldset>
        </form>
      </section>
